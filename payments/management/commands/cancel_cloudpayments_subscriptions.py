...
# принудительно выключаем все рекуррентные платежи в CloudPayments
...
def _auth_header(public_id: str, secret: str) -> str:
    # CloudPayments ожидает basic-auth с публичным id и секретом
    ...
    def handle(self, *args, **options):
        ...
        for sub in subs:
            ...
            try:
                ...
                # логируем и идём дальше, чтобы не падать на первой ошибке
