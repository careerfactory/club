...
from users.api import api_profile, api_profile_by_telegram_id, api_profile_status, expire_user, invite_user
...
urlpatterns = [
    ...
    path("user/status", api_profile_status, name="api_profile_status"),
    path("user/invite", invite_user, name="invite_user"),
    path("user/expire", expire_user, name="expire_user"),
